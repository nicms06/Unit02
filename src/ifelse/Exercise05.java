/*
 * Escribir un programa que simule el juego de PIEDRA, PAPEL, TIJERA, pidiendo a cada jugador que escriba 
 * PIEDRA, PAPEL o TIJERA. El juego debe mostrar por pantalla quién ha ganado el juego tras jugar una partida. 
